...
describe("PostService", () => {
    ...
    describe("createPost", () => {
        ...
        it("should handle errors during post creation", () => __awaiter(void 0, void 0, void 0, function* () {
            const postInput = {
                _author_id: 'author_id',
                title: 'Title',
                description: 'Description'
            ...
            mockPostRepository.createPost.mockRejectedValue(error);
            const result = yield postService.createPost(postInput);
            expect(mockPostRepository.createPost).toHaveBeenCalledWith(postInput);
            expect(mockFormateDate).toHaveBeenCalledWith({ error });
            expect(result).toEqual(mockFormateDate.mock.results[0].value);
        }));
    });
});
